...
const [cats_l3, setcats_l3] = useState([])
  ...
  function l3push(e) {
      var store= []
      var storee= store.push(e.target.value)
      setcats_l3(store);
    // e.target.name=="cats_l3"&& setcats_l3(store);
    ...
    return (
        <div>
            ...
            <input name="cats_l3" onChange={(e)=>{l3push(e)} } placeholder="  sub-sub-catergory" value={cats_l3}/> 
