...
export default function Dashboard() {
                ...
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                    <h6 class="dropdown-header d-flex align-items-center">
                        ...
                        <div class="dropdown-user-details">
                            ...
                            <div class="dropdown-user-details-email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="295f455c474869484645074a4644">[email&#160;protected]</a></div>
                        </div>
                    </h6>
    ...
    <div id="layoutSidenav">
                ...
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <div class="collapse" id="collapseDashboards" data-bs-parent="#accordionSidenav">
                            <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                                ...
                                <a class="nav-link" href="dashboard-1.html">
                                    ...
                                    {/* --> */}
                                {/* <!--  */}
                                <a class="nav-link" href="dashboard-2.html">Account Update</a> 
                                {/* --> */}
                        ...
                        <div class="collapse" id="collapseFlows" data-bs-parent="#accordionSidenav">
                            <nav class="sidenav-menu-nested nav">
                                {/* <!--  */}
                                {/* <Link class="nav-link" to="/product-details" >Product Details</Link>
                                <Link class="nav-link" to="/Product-order" >Product Order</Link>
                                <Link class="nav-link" to="/product-Register" >Product Registration</Link>
                                <Link class="nav-link"  to="/product-cart" >Product Cart</Link> */}
        ...
        <div id="layoutSidenav_content">
            <main>
            <Switch>
                                <Route path="/product-cart" exact component={Tables} />
