...
export default function Header() {
    ...
    return (<NavLink  to='/category1'><li  value={m}   onClick={(f)=>{setStoreThree(f.target.value) }}  >{m}</li></NavLink>)
...
// var all=uniquecat.map((u)=>{return(
//     <li><a href="product.html">{u}</a>
//         <ul>
...
//                 <ul>
//                     <li><a href="product.html">{SubSubCategory}</a></li>
...
<li><a href="product.html">{uniquecat}</a>
                               <ul>
                                   <li><a href="#">{SubCategory}</a>
                                       <ul>
                                           <li><a href="product.html">{SubSubCategory}</a></li>
